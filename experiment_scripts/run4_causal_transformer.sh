...
NUM_NODES=1
USER="single_user"
MODEL="transformer_encoder_conv_subsample_med"
BATCH_SIZE=32
CLUSTER="local"
LOG_DIR="logs"
SEED=0
...
EXP_NAME="${MODEL}_BS${BATCH_SIZE}_GA${GRAD_ACCUM}_LR${LEARNING_RATE}_SEED${SEED}_EPOCHS${MAX_EPOCHS}_6Layers_512d_8head_0.15Dropout_conv128_causal_roto"
