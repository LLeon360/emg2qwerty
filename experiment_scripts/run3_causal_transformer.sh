...
NUM_NODES=1
USER="single_user"
MODEL="transformer_encoder_conv_subsample_small"
BATCH_SIZE=32
CLUSTER="local"
LOG_DIR="logs"
SEED=0
...
EXP_NAME="${MODEL}_BS${BATCH_SIZE}_GA${GRAD_ACCUM}_LR${LEARNING_RATE}_SEED${SEED}_EPOCHS${MAX_EPOCHS}_4Layers_384d_8head_0.1Dropout_conv64_causal_roto"
